        ...
        <div class="flex flex-col md:flex-row space-y-8 md:space-y-0 md:gap-52 p-8  rounded-lg h-5/6 w-9/12 ">
            ...
            <form action="">
                <label class="block">
                    ...
                    <input type="text" class="mt-1 block w-full border-4 border-green-500 rounded-full px-6 py-3" >
                </label>
                <label class="block">
                    <span class="block text-sm font-medium text-gray-700">Email</span>
                    <input type="email" class="mt-1 block w-full border-4 border-green-500 rounded-full px-6 py-3">
                </label>
                <label class="block">
                    <span class="block text-sm font-medium text-gray-700">Assunto</span>
                    <input type="text" class="mt-1 block w-full border-4 border-green-500 rounded-full px-6 p-3">
                </label>
                <label class="block">
                    <span class="block text-sm font-medium text-gray-700">Sua mensagem</span>
                    <textarea class="mt-1 block w-full border-4 border-green-500 rounded-xl px-6 py-3"></textarea>
                </label>
