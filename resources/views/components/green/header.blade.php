<header class="bg-white">
    <div class="flex items-center justify-between ">
        ...
        <div id="logo" class="flex items-center border bg-customGreen  rounded-br-only">
            <img src="{{ asset('images/logo.png') }}" alt="Logo" class=" pl-5 pb-3 pr-7 pt-1">
        </div>
        ...
        <nav id="navbar" class="hidden  md:flex items-center space-x-12 gap-14">
            ...
            <a href="#" class="text-customBlue text-2xl font-itim hover:text-green-600 hover:underline hover:pb-3">Doações</a>
            <a href="#" class="text-customGreen text-2xl font-itim hover:text-green-600 hover:underline hover:pb-3">Voluntários</a>
        </nav>
        ...
        <div id="userAction" class="hidden md:flex items-center space-x-2 mr-5 ">
            <a href="#" class="text-gray-600 hover:text-green-600">
                <img class="h-10 mr-5 " src="{{ asset('images/icons/userIconGreen.png') }}" alt="">
            </a>
