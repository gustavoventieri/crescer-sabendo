<header class="bg-white ">
    <div class="flex items-center justify-between ">
        ...
        <nav id="navbar" class="hidden  md:flex items-center space-x-12 gap-14">
            <a href="#" class="text-purple-700  text-3xl font-itim hover:text-purple-900 hover:underline hover:pb-3 ">Home</a>
            <a href="#aboutus" class="text-customBlue text-3xl font-itim hover:text-purple-900 hover:underline hover:pb-3" >Sobre nós</a>
            <a href="#sponsors" class="text-customBlue text-3xl font-itim hover:text-purple-900 hover:underline hover:pb-3">Parcerias</a>
            <a href="{{ url('/donates')}}" class="text-customBlue text-3xl font-itim hover:text-purple-900 hover:underline hover:pb-3">Doações</a>
            <a href="{{ url('/donates')}}" class="text-customBlue text-3xl font-itim hover:text-purple-900 hover:underline hover:pb-3">Voluntários</a>
        </nav>
