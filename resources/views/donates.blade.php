...
<body class="bg-gray-100 overflow-x-hidden">
    <header class="bg-white  ">
        ...
        <div id="logo" class="flex items-center border bg-customGreen rounded-br-only">
            ...
            <nav id="navbar" class="hidden  md:flex items-center space-x-12 gap-14">
                ...
                <a href="#doacao" class="text-green-500 text-2xl font-itim hover:text-green-600 hover:underline hover:pb-3">Doações</a>
                <a href="#voluntario" class="text-customBlue text-2xl font-itim hover:text-green-600 hover:underline hover:pb-3">Voluntários</a>
            </nav>
    ...
    <div id="voluntario" class="flex flex-col items-center w-auto justify-center">
