                    ...
                    <tr class="bg-customBlue2 border border-black text-left">
                        ...
                        <th class="py-2 px-4 text-center">
                            <div class="hidden md:block relative text-left">
                                <input type="text" class="py-2 pl-4 w-56 rounded-lg border font-normal border-gray-300 focus:outline-none focus:ring focus:border-blue-300 " placeholder="Pesquisar...">
