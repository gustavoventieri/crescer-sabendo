    ...
    <body class="bg-gray-100 overflow-x-hidden">
        <header class="bg-white  ">
            <div class="flex items-center justify-between ">
                <div id="logo" class="flex items-center border p-5 bg-customBlue2 rounded-br-only">
                ...
                <nav id="navbar" class="hidden  md:flex items-center space-x-12 gap-14">
                    ...
                    <a href="#" class="text-customBlue  text-2xl font-itim hover:text-blue-700 hover:underline hover:pb-3 ">Aprovar ONG's</a>
                </nav>
