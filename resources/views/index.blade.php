    ...
    <body class="bg-gray-100 overflow-x-hidden">
        ...
        <!-- AboutUs -->
        <h1 class="text-6xl font-itim mt-20 text-center text-purple-700">ONGs</h1>
        <div id="aboutus" class="flex  items-center justify-center">
            <div class="relative w-full">
                ...
                <div id="text-container" class="absolute inset-0 flex flex-col items-start  md:ml-28 md:pt-52 mt-20 p-6">
                    <p   id="textP" class="text-base md:text-2xl font-itim">Descubra as organizações incríveis que já fazem parte da nossa plataforma, além dos cursos incríveis que elas oferecem gratuitamente. <br><br> Você também pode contribuir! Escolha uma das ONGs abaixo para acessar seu perfil e encontrar informações sobre como ajudar por meio de doações ou divulgando suas ações sociais..</p>
                </div>
            </div>
        </div>
        <!-- End AboutUs -->
